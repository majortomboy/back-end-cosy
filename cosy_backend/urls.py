...
urlpatterns = [
    ...
    path('projects/<int:pk>/references/', views.ProjectReferencePhotoList.as_view()),
    ...
    path('references/', views.ReferencePhotoList.as_view()),
    path('references/<int:pk>/', views.ReferencePhotoDetail.as_view()),
